...
const DROID_ART = {
  // Mouse Droid: low wedge-shaped box, twin red sensor eyes, wheels
  ...
  // B1 Battle Droid: skeletal tan, huge oval head, backpack, thin limbs
  b1: `<ellipse cx="30" cy="8" rx="11" ry="8" fill="#c8b87a"/><rect x="27" y="15" width="6" height="8" fill="#bfaf70"/><rect x="20" y="23" width="18" height="16" rx="3" fill="#c4b475"/><rect x="37" y="21" width="10" height="13" rx="2" fill="#b0a060"/><line x1="20" y1="27" x2="5" y2="44" stroke="#c4b475" stroke-width="3.5" stroke-linecap="round"/><line x1="38" y1="27" x2="52" y2="40" stroke="#c4b475" stroke-width="3.5" stroke-linecap="round"/><circle cx="4" cy="45" r="3" fill="#b4a465"/><circle cx="53" cy="41" r="3" fill="#b4a465"/><line x1="25" y1="39" x2="22" y2="66" stroke="#c4b475" stroke-width="4.5" stroke-linecap="round"/><line x1="35" y1="39" x2="38" y2="66" stroke="#c4b475" stroke-width="4.5" stroke-linecap="round"/><ellipse cx="22" cy="68" rx="6" ry="4" fill="#aaa050"/><ellipse cx="38" cy="68" rx="6" ry="4" fill="#aaa050"/><circle cx="26" cy="8" r="3" fill="#442200" opacity="0.9"/><circle cx="34" cy="8" r="3" fill="#442200" opacity="0.9"/>`,
