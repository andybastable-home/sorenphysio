...
const DROID_ART = {
  ...
  // B1 Battle Droid: wide horizontal oval head (flying-saucer shape), dark eye sockets, backpack, skeletal limbs
  b1: `<ellipse cx="30" cy="9" rx="15" ry="7" fill="#c8b87a"/><circle cx="23" cy="9" r="3.5" fill="#1a0a00"/><circle cx="37" cy="9" r="3.5" fill="#1a0a00"/><circle cx="23" cy="9" r="1.8" fill="#660000" opacity="0.85"/><circle cx="37" cy="9" r="1.8" fill="#660000" opacity="0.85"/><rect x="28" y="15" width="4" height="8" rx="1" fill="#bab06a"/><rect x="22" y="23" width="16" height="14" rx="2" fill="#c4b475"/><rect x="37" y="21" width="11" height="12" rx="2" fill="#b0a060"/><rect x="38" y="22" width="9" height="4" rx="1" fill="#9a8a50" opacity="0.6"/><line x1="22" y1="28" x2="6" y2="43" stroke="#c0b070" stroke-width="3" stroke-linecap="round"/><circle cx="5" cy="44" r="2.5" fill="#b0a060"/><line x1="38" y1="28" x2="52" y2="41" stroke="#c0b070" stroke-width="3" stroke-linecap="round"/><circle cx="53" cy="42" r="2.5" fill="#b0a060"/><line x1="26" y1="37" x2="23" y2="65" stroke="#c0b070" stroke-width="3.5" stroke-linecap="round"/><line x1="34" y1="37" x2="37" y2="65" stroke="#c0b070" stroke-width="3.5" stroke-linecap="round"/><ellipse cx="23" cy="67" rx="6" ry="3.5" fill="#a89840"/><ellipse cx="37" cy="67" rx="6" ry="3.5" fill="#a89840"/>`,
